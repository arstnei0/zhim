...
const App: Component = () => {
	return (
		<div class="container">
			...
			<h2 class="hero-text">
				You{"'"}ve successfully created an Electron project with Solid
				and TypeScript
			</h2>
			...
			<div class="features">
				<div class="feature-item">
					<article>
						...
						<p class="detail">
							Config with <span>electron.vite.config.ts</span> and
							refer to the{" "}
							<a
								target="_blank"
				...
				<div class="feature-item">
					<article>
						...
						<p class="detail">
							Edit <span>src/renderer</span> files to test HMR.
							See{" "}
							<a
								target="_blank"
